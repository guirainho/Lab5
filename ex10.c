...
a UNIÃO entre os vetores, ou seja, os elementos do vetor A mais aos elementos do vetor
B, desconsiderando os números repetidos de A em B. Os vetores dados não possuem valores duplicados e
não estão ordenados.
Exemplo:
